...
async function remotewsConnect() {
  const wssDetails = {
    IP: document.getElementById("remoteIP").value,
    PORT: document.getElementById("remotePort").value,
    PW: document.getElementById("remotePW").value,
  };
  ...
  localStorage.setItem("remote_wssDetails", JSON.stringify(wssDetails))
}
